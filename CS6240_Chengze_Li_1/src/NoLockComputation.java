...
/**
 * this class can create a thread object which doesn't add lock on shared data structure
 */
public class NoLockComputation extends Thread {
    Map<String, int[]> map;
    private List<String> content;

    public NoLockComputation(List<String> content, Map<String, int[]> map) {
